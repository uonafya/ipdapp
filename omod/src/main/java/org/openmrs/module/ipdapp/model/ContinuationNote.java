...
public class ContinuationNote {

    private static Logger logger = LoggerFactory.getLogger(ContinuationNote.class);
    ...
    public ContinuationNote () {
    }

    public ContinuationNote(int patientId) {
        super();
