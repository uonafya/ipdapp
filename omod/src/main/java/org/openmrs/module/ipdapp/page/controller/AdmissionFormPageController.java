    ...
    public String post(HttpServletRequest request, PageModel model,
        ...
        try {
            ...
            if (patientAdmissionLog != null && patientAdmissionLog.getId() != null) {
                ...
                Concept concept1 = Context.getConceptService().getConceptByUuid("404b4f27-641f-4889-ae91-66fa2165db0c");//admission fee
                Concept concept2 = Context.getConceptService().getConceptByUuid("06fca151-2945-49a5-9ba3-032dc2f947e1");//catering fee
                al.add(concept1);
                al.add(concept2);
